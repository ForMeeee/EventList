            ...
            <Row>
              ...
              <Col xs="12" lg="9">
                <div className="mb-3">
                  <Badge
                    pill
                    bg={state.filter.category === "" ? "secondary" : "light"}
                    text="dark"
                    className="me-2"
                  ...
                  {categories.map((val, key) => {
                    return (
                      <Badge
                        pill
                        bg={
                          state.filter.category === val._id
                            ? "secondary"
                            : "light"
                        }
                        text="dark"
                        className="me-2"
                        onClick={handleChangeCat(val._id)}
                      >
                        {val.name}
                      </Badge>
                    );
                        ...
                        <div className="card-grow h-100">
                          <span className="badge-pricing">
                            {data.tickets[0].price === 0 ? (
                              ...
                              <>
                                Rp
                                <FormatMoney amount={data.tickets[0].price} />
                              </>
                            )}
                          </span>
                          <img
